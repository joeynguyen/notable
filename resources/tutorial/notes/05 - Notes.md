...
Attachments can be added by clicking the attachment in the mainbar's toolbar. Attachments are simply copied into your data directory, under the `attachments` sub-directory.
